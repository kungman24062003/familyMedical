...
public class MessageKey {
    ...
    public static final String GET_ALL_MEMBERS_SUCCESS = "Get all family members successfully.";
    ...
    public static final String GET_MEDICAL_RESULTS_BY_MEMBER_ID_SUCCESS = null;
}
